...
- Queue Machine module root is canonical local section `01` at `modules/queue-machine/`. Sections: `01` Narrative, `02` Taxonomy (`modules/queue-machine/taxonomy/`), `03` Explore (`modules/queue-machine/explore/`), `04` Concept Map (`modules/queue-machine/concept-graph/`).
