...
**Direction:** Define canonical roles first: primary action, secondary action, segmented mode switch, filter chip, binary toggle, and text disclosure. Then map each existing variant to one role or mark it as a contextual exception.
