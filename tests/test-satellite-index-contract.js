...
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-status'), 'backdrop-filter: var(--satellite-hud-blur);', 'Three.js HUD status text should sit in its own glass pill');
...
assertIncludes(css, '.satellite-three-hud .satellite-analyse-btn:disabled {\n  border-color: var(--satellite-hud-border-strong);\n  background: var(--satellite-hud-surface-strong);', 'Three.js zoom-needed button should use the glass primary state instead of the attention-control accent');
assertIncludes(css, '.satellite-three-hud .satellite-toggle-control[aria-pressed="true"],\n.satellite-three-hud .satellite-terrain-switch[aria-pressed="true"] {\n  background: var(--satellite-hud-surface-strong);', 'Three.js active HUD toggles should use a neutral transparent glass state');
...
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-controls'), 'border: 0;', 'Three.js HUD toolbar wrapper should not add a second border behind controls');
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-controls'), 'gap: 0.34rem;', 'Three.js HUD should separate action and text pills without oversized spacing');
...
assertIncludes(css, '  min-height: 1.9rem;\n  padding: 0.18rem 0.54rem;\n  border: 1px solid var(--satellite-hud-border);\n  background: var(--satellite-hud-surface);\n  -webkit-backdrop-filter: var(--satellite-hud-blur);\n  backdrop-filter: var(--satellite-hud-blur);', 'Three.js HUD controls should be compact glass pills over the dynamic map/canvas');
assertIncludes(css, '  text-shadow: none;\n}\n\n.satellite-three-hud .satellite-terrain-switch {\n  flex-direction: column;', 'Three.js HUD controls should remove text halo before compacting the terrain switch');
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-terrain-switch-label'), 'font-size: 0.48rem;', 'Three.js terrain switch label should stay compact in the HUD');
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-terrain-switch-track'), 'inline-size: 1.32rem;', 'Three.js terrain switch track should be compact in the HUD');
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-terrain-switch[aria-pressed="true"] .satellite-terrain-switch-thumb'), 'inset-inline-start: calc(100% - 0.44rem);', 'Three.js compact terrain switch thumb should visibly move when terrain is on');
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-analyse-btn:not(:disabled)'), 'border-color: var(--satellite-hud-border-strong);', 'Three.js enabled analyze button should be emphasized by a quiet border, not a heavy fill');
...
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-viewport-readout'), 'border: 1px solid var(--satellite-hud-border);', 'Three.js viewport readout should sit in a separate glass pill');
...
assertIncludes(css, '.satellite-three-hud .satellite-terrain-switch-label {\n    display: none;', 'Three.js mobile HUD should hide the terrain text label to preserve space');
...
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-viewport-readout--blocked'), 'background: var(--satellite-hud-surface);', 'Three.js blocked viewport readout should keep the normal glass background because the text already carries the state change');
