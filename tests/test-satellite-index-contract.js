...
assertIncludes(selectorBlock(css, '.satellite-three-hud .satellite-viewport-readout:not(.satellite-viewport-readout--blocked)'), 'background: var(--experience-switch-surface);', 'Three.js viewport readout should use the CV switch yellow for live/active state');
