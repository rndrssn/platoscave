...
assertIncludes(selectorBlock(css, '.satellite-three-hud'), '--satellite-hud-surface: color-mix(in srgb, var(--paper) 82%, transparent 18%);', 'Three.js HUD controls should use quiet neutral instrument-panel surfaces');
...
assertIncludes(css, '.satellite-three-hud .satellite-analyse-btn:disabled {\n  border-color: transparent;\n  background: var(--satellite-hud-muted-surface);', 'Three.js zoom-needed button should use the disabled toolbar segment state instead of the attention-control accent');
